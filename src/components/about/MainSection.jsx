...
export const MainSection = () => {
    return (
        <div className="bg-black p-10 relative z-20">
            <div className="space-x-16 mt-6 md:p-2">
                {/* <div className="w-[50%] order-2 m-10"><img src={image1} alt="Lab-image" className="w-full"></img></div> */}
                <p className="text-white mt-3 text-justify text-lg md:text-2xl font-light w-full min-w-48 order-1">
            ...
            <h1 className="mt-20 ml-8 text-3xl md:text-5xl font-bold text-sky-500">Mission</h1>
            <p className="text-white mt-2 text-lg md:text-xl md:ml-9 text-justify md:mr-10">
            ...
            <h1 className="mt-20 ml-8 text-3xl md:text-5xl font-bold text-sky-500">Vision</h1>
            <p className="text-white mt-2 text-lg md:text-xl md:ml-9 text-justify md:mr-10">
            ...
            <div className="max-md:space-y-32 md:space-x-40 mt-20 m-auto md:flex justify-center grid grid-cols-1 justify-items-center">
                <div className="min-w-32 min-h-32 h-60 w-60 max-md:w-36 max-md:h-36">
                    ...
                    <p className="text-white text-base md:text-xl">Technical Excellence</p>
                </div>
                <div className="min-w-32 min-h-32 h-60 w-60 max-md:w-36 max-md:h-36">
                    ...
                    <p className="text-white text-base md:text-xl">Educational and Technical Advancement</p>
                </div>
                <div className="min-w-32 min-h-32 h-60 w-60 max-md:w-36 max-md:h-36">
            ...
            <div className="min-w-32 min-h-32 h-60 w-60 mt-32 md:mt-32 md:m-auto max-md:w-36 max-md:h-36 justify-items-center mx-auto">
                ...
                <p className="text-white text-base md:text-xl">Diversity, Equity and Inclusion</p>
            </div>
            <div className="mt-32">
                <a className="font-semibold text-xl md:text-2xl text-indigo-500 ml-10 underline" href="https://services.acm.org/public/qj/quickjoin/qj_control.cfm?promo=PWEBTOP&form_type=Student" target="_blank">JOIN ACM NOW</a>
            </div>
        </div>
    )
}

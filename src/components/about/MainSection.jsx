...
export const MainSection = () => {
    return (
        <div className="bg-black p-10 relative z-20">
            ...
            <div className="space-x-20 mt-20 m-auto flex justify-center">
                <div className="min-w- min-h-32 h-80 w-80">
                    <div className="w-full h-full bg-blue-400 pt-10">
                        <img src={img3} alt="Technical Excellence" className="h-3/4 w-5/6 m-auto" />
                    </div>
                    <p className="text-white text-xl">Technical Excellence</p>
                </div>
                <div className="min-w- min-h-32 h-80 w-80">
                    <div className="w-full  h-full bg-orange-900 pt-10">
                ...
                <div className="min-w- min-h-32 h-80 w-80 mt-32 m-auto">
            ...
            <div className="mt-32">
                <a className="font-semibold text-2xl text-indigo-500 ml-10 underline">JOIN ACM NOW</a>
            </div>
        </div>
    )
}
